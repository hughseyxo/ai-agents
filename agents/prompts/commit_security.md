...
- Do NOT flag Markdown files in `docs/superpowers/plans/` starting with `librarian-arch-`. These are passive implementation plans generated by the Librarian agent and require human review.
