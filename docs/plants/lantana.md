...
- Flagged for a recovery photo check (`needs_photo: true`) and a review task is active to reduce watering interval to 5–6 days.

### 2026-05-28
- Clear indicators of underwatering observed: the assessment from 2026-05-25 noted wilted and droopy leaves despite healthy orange flowers.
- The current base frequency of 7 days is insufficient under outdoor full sun conditions in late May heat.
- Currently flagged for a photo check (`needs_photo: true`) to assess recovery, with a review task active in Todoist to shorten the watering interval to 5–6 days.

### 2026-05-28
- Last watered 2026-05-24 (4 days ago); frequency set at 7 days
- Assessment from 2026-05-25 (yesterday) shows **wilted, droopy leaves** — clear indicator of underwatering
